...
const char* mqtt_pub_topic = "Sensor";//publish pada mqtt
const char* CL = "LSKK-HA-Saklar-Water-lvl";
int loop_count  = 0 ; //loop count loop

String statusDevice [2] = {"1","1"};
...
String button_status[2];
String prevpubmsg = "";
void loop() {
  String pubmsg = "";
  String input_guid = "2bf0c806-eebb-467c-9a47-cff1ded5263c";
  ...
  pubmsg = input_guid + "#" + button_status[0] + button_status[1];
  //Kirim
